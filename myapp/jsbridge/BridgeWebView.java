...
public class BridgeWebView extends WebView
        implements com.example.myapp.jsbridge.LvUJsBridge {

    private final String TAG = "BridgeWebView";

    String toLoadJs = "LvUJsBridge.js";
    Map<String, com.example.myapp.jsbridge.CallBackFunction> responseCallbacks = new HashMap<String, CallBackFunction>();
    Map<String, BridgeHandler> messageHandlers = new HashMap<String, BridgeHandler>();
    BridgeHandler defaultHandler = new com.example.myapp.jsbridge.DefaultHandler();

    List<com.example.myapp.jsbridge.Message> startupMessage = new ArrayList<com.example.myapp.jsbridge.Message>();
    long uniqueId = 0;
    public int depath = 0;
...
//			this.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    ...
    private void handlerReturnData(String url) {
        ...
        com.example.myapp.jsbridge.CallBackFunction f = responseCallbacks.get(functionName);
...
//			handler.cancel();
    ...
    private void doSend(String handlerName, String data, CallBackFunction responseCallback) {
        com.example.myapp.jsbridge.Message m = new com.example.myapp.jsbridge.Message();
    ...
    private void queueMessage(com.example.myapp.jsbridge.Message m) {
        if (startupMessage != null) {
    ...
    private void dispatchMessage(com.example.myapp.jsbridge.Message m) {
        ...
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            loadUrl(BridgeUtil.JS_FETCH_QUEUE_FROM_JAVA, new CallBackFunction() {
                ...
                public void onCallBack(String data) {
                    // deserializeMessage
                    List<com.example.myapp.jsbridge.Message> list = null;
                    try {
                        list = com.example.myapp.jsbridge.Message.toArrayList(data);
                    } catch (Exception e) {
                        e.printStackTrace();
                        return;
                    }
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        com.example.myapp.jsbridge.Message m = list.get(i);
                        ...
                        if (!TextUtils.isEmpty(responseId)) {
                            ...
                            if (!TextUtils.isEmpty(callbackId)) {
                                responseFunction = new CallBackFunction() {
                                    @Override
                                    public void onCallBack(String data) {
                                        com.example.myapp.jsbridge.Message responseMsg = new Message();
    ...
    public void loadUrl(String jsUrl, com.example.myapp.jsbridge.CallBackFunction returnCallback) {
        this.loadUrl(jsUrl);
     ...
     * @param callBack
     */
    public void callHandler(String handlerName, String data, com.example.myapp.jsbridge.CallBackFunction callBack) {
