...
public class VideoCategoryResponse implements Serializable {
    ...
    public static class PageBean {
        ...
        private List<com.example.myapp.entity.CategoryEntity> list;
        ...
        public List<com.example.myapp.entity.CategoryEntity> getList() {
            return list;
        }

        public void setList(List<com.example.myapp.entity.CategoryEntity> list) {
            this.list = list;
        }
    }
}
